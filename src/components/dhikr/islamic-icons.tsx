...
import {
  ...
  CircleDot, Landmark, PalmTree, Trees, StarOff, X, ArrowRight, Check, Pencil, LogOut, User,
...
export {
  ...
  Wind, Brain, Flower2, Cloud, Droplets, Play, Pause, RotateCw, Download, Upload, Pencil, LogOut, User
};
